LANGUAGE = {
	...
	mustBeCP = "You must be in the First Order to do this.",
	objectives = "Objectives",
	notCombine = "You must be a member of the First Order to do this.",
	prioritySet = "You have changed the priority status of %s.",
	noReqDev = "You do not own a request device.",
	fRebelName = "Rebel",
	fTrooperName = "Trooper",
	fSTrooperName = "Shadow Trooper",
	fCptName = "Captain Phasma"
}
